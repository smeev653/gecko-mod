...
NDiplomacy = {
	...
	OVEREXTENSION_THRESHOLD = 1.5,				-- at which threshold you can get events
...
NCountry = {
	...
	EXPLORE_COAST_EVENT_CHANCE = 5,			-- Chance (in %) of getting an event when exploring coasts
...
NMilitary = {
	...
	COSSACKS_MAXIMUM_RATIO = 0.2,					-- Maximum number of Cossacks regiments, relative to force limit
	REVOLUTIONARY_GUARD_MAXIMUM_RATIO = 1.0,			-- Maximum number of Revolutionary Guard regiments, relative to force limit
	RAJPUT_MAXIMUM_RATIO = 0.2,						-- Maximum number of Rajput regiments, relative to force limit
...
NAI = {
	...
	BUY_INDULGENCE_BASE_AI_DESIRE = 0,						-- AI desire for buy indulgence if curia controller has negative opinion of it, multiplied by budget/cost
	BUY_INDULGENCE_RIVAL_AI_DESIRE = 0,						-- AI desire for buy indulgence if curia controller rivaled it, multiplied by budget/cost
	BUY_INDULGENCE_EXCOM_AI_DESIRE = 0,						-- AI desire for buy indulgence if it's excommunicated, multiplied by budget/cost
