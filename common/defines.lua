...
NCountry = {
	...
	ABDICATE_LEGITIMACY_THRESHOLD = 20,
...
NMilitary = {
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 1.2,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
	...
	LEADER_MAX_PIPS = 8,								-- Max general/admiral pips (per skill)
	...
	CREATE_JANISSARIES_MIL_COST = 7,				-- Cost to create janissaries (per unit)
